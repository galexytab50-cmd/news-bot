...
«امنیتی» باشد):
سیاسی | امنیتی | بین‌المللی | اقتصادی | مهاجرین | فرهنگی | فلسطین و مقاومت اسلامی
...
اگر خبر به «افغانستان و طالبان» مربوط است، طبق قانون ویرایشی، همیشه از
عبارت «حکومت سرپرست افغانستان» استفاده کنید، نه «طالبان».
...
۱) هیچ محتوای ضد ایران نباشد. ۲) طالبان = «حکومت سرپرست افغانستان».
۳) لحن حمایت‌گر از مردم افغانستان و پذیرش طالبان به‌عنوان واقعیت عینی،
بدون شناسایی حقوقی رسمی. ۴) اگر حوزه امنیتی/بین‌المللی است، مواضع دقیقاً
مطابق بندهای بالا (مخالفت با مداخله غرب، برجسته‌سازی خطر داعش، تاکید بر
مسئولیت‌پذیری امنیتی حکومت افغانستان) باشد. اگر متن این معیارها را نقض
می‌کند، پیش از خروجی اصلاحش کنید.
